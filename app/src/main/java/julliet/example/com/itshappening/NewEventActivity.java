...
public class NewEventActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextDesg = (EditText) findViewById(R.id.editTextPrice);
        editTextSal = (EditText) findViewById(R.id.editTextDecription);
    ...
    private void addEmployee() {
        ...
        class AddEmployee extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(NewEventActivity.this, "Adding...", "Wait...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Log.d("", s);
                Toast.makeText(NewEventActivity.this, s, Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                params.put(Config.EMAIL, "Birir@gmail.com");
